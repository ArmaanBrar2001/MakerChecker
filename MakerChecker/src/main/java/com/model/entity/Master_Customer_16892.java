...
@Entity
@Component
@Table(name = "Master_Customer_16892")
public class Master_Customer_16892 implements Serializable {

    private static final long serialVersionUID = 345678987L;
    ...
    @Column(name = "Record_Status", nullable = false, length = 1, columnDefinition = "varchar2(2" +
